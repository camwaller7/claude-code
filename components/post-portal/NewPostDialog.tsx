      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          {selectedPlatforms.includes('instagram') && (
            <div className="flex items-start gap-2 rounded-lg border border-amber-300 bg-amber-50 px-3 py-2.5 text-xs text-amber-900 dark:border-amber-500/40 dark:bg-amber-500/10 dark:text-amber-200">
              <span className="text-sm leading-none">🎵</span>
              <p>
                <span className="font-semibold">Add your Instagram song after publishing.</span> Meta only
                lets you add a track inside the Instagram app, so it can&apos;t be attached here. We&apos;ll
                notify you the moment this post is pushed so you can open it and add a trending song — don&apos;t
                miss it, it&apos;s a big engagement boost.
              </p>
            </div>
          )}
